# You will need the discord module - the others come preinstalled.
import discord
...
async def forecast(ctx, arg1, arg2, arg3, arg4):
    ...
    # Also sends the correct icon, by putting the variable that we defined earlier (weatherIcon) as a part of the image url, to get different results.
    # This one prints in normal text rather than an embed.

    if arg4 == 'Basic' or arg4 =='BASIC' or arg4 == 'basic' or arg4 == 'BAsic' or arg4 == 'bASIC' or arg4 == 'absic' or arg4 == 'Absic':
        await ctx.send('There will be **' + str(weatherDescription) + '** \nwith an average temperature of\n**' + str(dayTemp) + '°** celsius.')
        await ctx.send('http://openweathermap.org/img/wn/' + weatherIcon + '@2x.png')
        ...
        await ctx.send('Error: Arg4 was invalid')
